...
export class OCRService {
    ...
    async processDocument(documentId, filePath, documentType) {
    ...
    extractPassportData(text, ocrData) {
    ...
    extractDriversLicenseData(text, ocrData) {
    ...
    extractNationalIdData(text, ocrData) {
        // Extract name
    ...
    extractGenericData(text, ocrData) {
    ...
    calculateQualityScore(tesseractData) {
    ...
    async processWithAI(imageBuffer, documentType) {
        try {
    ...
    async processWithTesseract(imageBuffer, documentType) {
...
- Include ALL text you can see in the raw_text field`;
    ...
    parseAIResponse(aiResponse, documentType) {
        try {
    ...
    extractFromAIText(text, documentType) {

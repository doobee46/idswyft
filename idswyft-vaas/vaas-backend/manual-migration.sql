-- Manual migration script for organization main API keys
-- Run this if the automatic migration hasn't been applied
...
CREATE TABLE IF NOT EXISTS vaas_organization_main_api_keys (
  ...
  key_prefix VARCHAR(50) NOT NULL, -- First part of key for display (e.g., "ik_abc123...")
...
SELECT 'vaas_organization_main_api_keys table created successfully' AS status;
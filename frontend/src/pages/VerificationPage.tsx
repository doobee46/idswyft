      ...
      <div className="bg-white rounded-lg shadow-md p-8">
        ...
        <div className="mt-8 bg-blue-50 p-4 rounded-md">
          ...
          <ol className="text-blue-800 text-sm space-y-1 list-decimal list-inside">
            ...
            <li>Provide a unique user ID for this verification session</li>
            <li>Upload a government-issued ID document (passport, driver's license, etc.)</li>
            <li>Upload a selfie for face matching and liveness detection</li>
            <li>Check the verification status to see results</li>
          </ol>
        </div>
      </div>
    </div>
